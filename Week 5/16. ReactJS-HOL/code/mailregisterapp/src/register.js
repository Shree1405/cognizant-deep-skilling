...
// Utility function to check if all errors are empty
...
// Regular expression for email validation (From Hint Image 3)
...
class Register extends Component {
  ...
  // Handle field updates with validation logic (From Hint Images 2 & 3)
  handleChange = (event) => {
  ...
  // Handle form submission (From Hint Image 1)
  handleSubmit = (event) => {
    event.preventDefault();
        ...
        <form onSubmit={this.handleSubmit} style={{ display: 'inline-block' }}>
          <table style={{ margin: '0 auto', textAlign: 'left' }}>
            <tbody>
              ...
              <tr>
                <td style={{ padding: '8px', fontWeight: 'bold' }}>Password:</td>
                <td style={{ padding: '8px' }}>
                  <input
                    type="password"
                    name="password"
